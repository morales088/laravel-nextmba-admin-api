...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;">Purchase Confirmation:</p>
  </div>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
    ...
    <p style="font-size: 14px; line-height: 140%;">Course: {{ $course }}.</p>
    <p style="font-size: 14px; line-height: 140%;">Reference ID: {{ $reference_id }}</p>
    <p style="font-size: 14px; line-height: 140%;">Quatity: {{ $qty }}</p>
    <p style="font-size: 14px; line-height: 140%;">Amount: {{ $amount }}</p>
